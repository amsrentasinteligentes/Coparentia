...
export interface FooterLegalProps {
  appName: string;
  logo?: ReactNode;
  /** true cuando el logo ya incluye el nombre (horizontal). */
...
export function FooterLegal({ appName, logo, marcaSoloLogo = false, enlaces, soporteEmail, anio }: FooterLegalProps) {
